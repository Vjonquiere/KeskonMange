...
CREATE TABLE IF NOT EXISTS recipes (id BIGINT PRIMARY KEY AUTO_INCREMENT, title CHARACTER VARYING(128), type CHARACTER VARYING(7), difficulty INT, cost INT, vegetarian BOOLEAN, vegan BOOLEAN, hasGluten BOOLEAN, hasLactose BOOLEAN, hasPork BOOLEAN, salty BOOLEAN, sweet BOOLEAN);
...
CREATE TABLE IF NOT EXISTS recipes_ingredients_link (recipeId BIGINT, ingredientId BIGINT);
