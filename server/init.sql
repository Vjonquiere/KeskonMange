...
CREATE TABLE IF NOT EXISTS calendar (timestamp BIGINT, recipeId BIGINT, done BOOLEAN, day INT);
CREATE TABLE IF NOT EXISTS ingredients (id BIGINT PRIMARY KEY AUTO_INCREMENT, name CHARACTER VARYING(32), type CHARACTER VARYING(32));
