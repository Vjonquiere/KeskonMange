        ...
        return Row(
          children: [
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(AppLocalizations.of(context)!.planning_mealTime(TimeOfDay(hour: 20, minute: 30).format(context))),
                Text(AppLocalizations.of(context)!.planning_startCooking(50)),
              ],
            ),
          ],
        );
